...
export default function CampusAdmin() {
  ...
  const uploadMedia = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      else { updateStage({ mediaUrl: data.url }); setNotice("Archivo subido y conectado a esta etapa. Guardá o publicá para conservarlo."); }
