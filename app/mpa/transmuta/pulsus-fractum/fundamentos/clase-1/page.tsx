    ...
    <main className="pf-classroom">
      ...
      <div className="pf-classroom-layout">
        <aside className="pf-classroom-index">
          ...
          <div className="pf-classroom-resource"><span>Cuaderno de la clase</span><b>Vigilia I · El arte de discernir tu juicio de la realidad</b><a href="/materiales/cuaderno-vigilia-1.pdf" download>Descargar PDF ↓</a></div>
        </aside>
